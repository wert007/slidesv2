...
namespace Minsk.CodeAnalysis
{
	internal static class FormulaCreator
	{
		...
		public static Function CreateFunction(this Evaluator e, BoundExpression expression, BoundExpression dependent)
		{
			return new Function(CreateFormula(e, expression, dependent));
		}
		...
		internal sealed class Evaluator
		{
			...
			private object EvaluateFieldAssignmentExpression(BoundFieldAssignmentExpression node)
			{
				...
				{
					var d = new Dependency((Element)parent, fieldName, this.CreateFunction(node.Initializer, dependent));
